...
--@Descripción: Creación de sinónimos en jzrbdd_s2
...
--auto
create or replace synonym auto_f1 for auto_f1_jzr_s2;
...
--historico_status
create or replace synonym historico_status_f1 for historico_status_f1_jzr_s2;
...
create or replace synonym cliente_f3 for cliente_f3_jzr_s2;
...
create or replace synonym pago_auto_f3 for pago_auto_f3_jzr_s2;
...
create or replace synonym marca_r4 for marca_r_jzr_s2;
...
create or replace synonym modelo_r4 for modelo_r_jzr_s2;