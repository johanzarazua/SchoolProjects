...
--@Descripción: Creación de sinónimos en ahgbdd_s1

--pais
create or replace synonym pais_f1 for pais_f1_ahg_s1;
...
create or replace synonym sucursal_f2 for sucursal_f2_ahg_s1;
...
create or replace synonym auto_f2 for auto_f2_ahg_s1;
create or replace synonym auto_f3 for auto_f3_ahg_s2@ahgbdd_s2;

--auto_particular
create or replace synonym auto_particular_f1 for auto_particular_f1_ahg_s1;
create or replace synonym auto_particular_f2 for auto_particular_f2_ahg_s2@ahgbdd_s2;

--auto_carga
create or replace synonym auto_carga_f1 for auto_carga_f1_ahg_s1;
...
--marca
create or replace synonym marca_r1 for marca_r_ahg_s1;
...
--modelo
create or replace synonym modelo_r1 for modelo_r_ahg_s1;
