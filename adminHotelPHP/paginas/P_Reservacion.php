    ...
    <body>
        ...
        <div class="container">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                <a class="nav-link" href="P_Inicial.php" id="inicial">Inicio</a>
            </ul>
            </div>
        </div>
        </nav>
                    ...
                    <div class="col-md-6">
                        <div class="man-container">
                            <div class="text-center topmargin-lg">
                                <h2><b>Reservación</b></h2>
                                <br>
                                <a href="P_ListadoHabi_Res.php"><h3>Realizar reservación</h3></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="man-container">
                            <div class="text-center topmargin-lg">
                                <h2><b>Servicios</b></h2>
                                <br>
                                <a href="P_ListadoReserv_Serv.php"><h3>Agregar servicio</h3></a>
                            </div>
                        </div>
                    </div> 
                </div>            
