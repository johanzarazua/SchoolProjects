                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        <tr>                 
                                        ...
                                        <td><a href="P_RegistroPago.php?idr=<?php echo urlencode($fila['idReservacion'])?>&hab=<?php echo urlencode($fila['Numero'].", ".$fila['Tipo'])?>&fi=<?php echo urlencode($fila['Fecha_Ingreso'])?>&fs=<?php echo urlencode($fila['Fecha_Salida'])?>&cos=<?php echo urlencode($fila['Costo'])?>" class="btn btn-primary">Seleccionar</a></td>
                        </tr>
                            <?php
                                    }
